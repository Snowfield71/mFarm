...
export const ITEM_DB: Record<string, ItemDef> = {
    ...
    carrot: { id: 'carrot', name: '胡萝卜', category: ItemCategory.CROP, description: '橙色蔬菜，清脆爽口', sellPrice: 25, unlockLevel: 3, rarity: 2, iconColor: '#FFA500', isCrop: true, growthTime: 120, harvestCount: 1 },
    pumpkin: { id: 'pumpkin', name: '南瓜', category: ItemCategory.CROP, description: '大南瓜，用于万圣节主题', sellPrice: 40, unlockLevel: 8, rarity: 2, iconColor: '#FF8C00', isCrop: true, growthTime: 180, harvestCount: 1 },
    strawberry: { id: 'strawberry', name: '草莓', category: ItemCategory.CROP, description: '红色果实，制作果酱', sellPrice: 30, unlockLevel: 12, rarity: 3, iconColor: '#FF1493', isCrop: true, growthTime: 120, harvestCount: 2 },
    cherry: { id: 'cherry', name: '樱桃', category: ItemCategory.CROP, description: '珍贵果实，特殊配方用', sellPrice: 35, unlockLevel: 16, rarity: 3, iconColor: '#DC143C', isCrop: true, growthTime: 150, harvestCount: 3 },
    banana: { id: 'banana', name: '香蕉', category: ItemCategory.CROP, description: '黄色水果，营养丰富', sellPrice: 22, unlockLevel: 10, rarity: 2, iconColor: '#FFD700', isCrop: true, growthTime: 100, harvestCount: 1 },
    apple: { id: 'apple', name: '苹果', category: ItemCategory.CROP, description: '红色水果，多用途', sellPrice: 28, unlockLevel: 14, rarity: 3, iconColor: '#FF4500', isCrop: true, growthTime: 140, harvestCount: 1 },
    lettuce: { id: 'lettuce', name: '生菜', category: ItemCategory.CROP, description: '绿色蔬菜，新鲜脆爽', sellPrice: 18, unlockLevel: 5, rarity: 2, iconColor: '#90EE90', isCrop: true, growthTime: 75, harvestCount: 2 },
    egg: { id: 'egg', name: '鸡蛋', category: ItemCategory.CROP, description: '养鸡场产出，烘焙必需', sellPrice: 25, unlockLevel: 6, rarity: 2, iconColor: '#FFD700', isCrop: true, growthTime: 110, harvestCount: 1 },
    milk: { id: 'milk', name: '牛奶', category: ItemCategory.CROP, description: '牧场产出，烹饪常用', sellPrice: 24, unlockLevel: 7, rarity: 2, iconColor: '#FFFFFF', isCrop: true, growthTime: 100, harvestCount: 1 },
    ...
    warehouse: { id: 'warehouse', name: '仓库', category: ItemCategory.BUILDING, description: '增加10格物品栏', sellPrice: 80, unlockLevel: 9, rarity: 4, iconColor: '#8B4513' },
    house: { id: 'house', name: '房屋', category: ItemCategory.BUILDING, description: '装饰建筑，无功能属性', sellPrice: 90, unlockLevel: 11, rarity: 3, iconColor: '#FF6347' },
    ...
    garden: { id: 'garden', name: '花园', category: ItemCategory.BUILDING, description: '装饰建筑，花朵盛开', sellPrice: 80, unlockLevel: 15, rarity: 3, iconColor: '#FFB6C1' },
    ...
    rose: { id: 'rose', name: '玫瑰', category: ItemCategory.DECORATION, description: '深红花朵，浪漫温馨', sellPrice: 30, unlockLevel: 5, rarity: 2, iconColor: '#DC143C' },
    tree: { id: 'tree', name: '树木', category: ItemCategory.DECORATION, description: '大树，提供荫凉', sellPrice: 40, unlockLevel: 6, rarity: 2, iconColor: '#228B22' },
    palmTree: { id: 'palmTree', name: '棕榈树', category: ItemCategory.DECORATION, description: '热带树木，度假风格', sellPrice: 50, unlockLevel: 10, rarity: 3, iconColor: '#228B22' },
    ...
    fence: { id: 'fence', name: '木栅栏', category: ItemCategory.DECORATION, description: '栅栏装饰，划分区域', sellPrice: 28, unlockLevel: 4, rarity: 2, iconColor: '#8B4513' },
    tent: { id: 'tent', name: '帐篷', category: ItemCategory.DECORATION, description: '露营帐篷，冒险风格', sellPrice: 60, unlockLevel: 14, rarity: 3, iconColor: '#FFB6C1' },
    pumpkinLantern: { id: 'pumpkinLantern', name: '南瓜灯', category: ItemCategory.DECORATION, description: '万圣节装饰，节庆风格', sellPrice: 40, unlockLevel: 8, rarity: 2, iconColor: '#FF8C00' },
